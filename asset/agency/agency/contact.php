        ...
        <div class="contacts-9 py-lg-5 py-md-4">
            <div class="container">
                ...
                <div class="contactct-fm map-content-9">
                    <form action="submit.php" class="pt-lg-4" method="post">
                        <div class="twice-two">
                            ...
                            <input type="tel" class="form-control" name="mobile" id="w3lSubject" placeholder="Moblie No." required="">
                        </div>

                        <textarea name="message" class="form-control" id="w3lMessage" placeholder="Message" required=""></textarea>
                        <div class="text-lg-center">
                            <button type="submit" class="btn btn-primary btn-style mt-lg-5 mt-4" value="submit">Send Message</button>
                        </div>
                    </form>
                </div>
